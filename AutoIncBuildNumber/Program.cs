    ...
    class Program
    {
        ...
        private static string incBuildNo(string strVersion, VERSION_PART part = VERSION_PART.REVISION)
        {
            ...
            try
            {
                ...
                if (version_idx == 0) { version[1] = "0"; version[2] = "0"; if (version.Length > 3) version[3] = "0"; }
                else if (version_idx == 1) { version[2] = "0"; if (version.Length > 3) version[3] = "0"; }
                else if (version_idx == 2) { if (version.Length > 3) version[3] = "0"; }
